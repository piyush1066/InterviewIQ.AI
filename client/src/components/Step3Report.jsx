...
function Step3Report({ report, error = "" }) {
  ...
  const downloadPDF = () => {
    try {
      ...
      if (finalScore >= 8) {
        advice =
          "Excellent performance. Maintain confidence and structure. Continue refinding clarity and supporting answers with strong real-world examples."
      } else if (finalScore >= 5) {
        advice =
      ...
      autoTable(doc, {
        ...
        headStyles: {
          0: { cellWidth: 10, helign: "center" },
          1: { cellWidth: 55 },
          2: { cellWidth: 20, helign: "center" },
          3: { cellWidth: "auto" },
        },
        alternateRowStyles: {
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8'>
      <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 '>
        ...
        <button onClick={downloadPDF} className='bg-emerald-600 hover:bg-emerald-700 text-white py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap px-3'>
          Download PDF
        </button>
            ...
            <div className='space-y-5'>
              {
                skills.map((s, i) => (
                  <div key={i}>
                    ...
                    <div className='bg-gray-200 h-2 sm:h3 rounded-full'>
