  ...
  return (
    <div className='min-h-screen bg-[#f3f3f3] flex flex-col'>
      ...
      <div className='flex-1 px-6 py-20'>
        ...
        <div className='text-center mb-28'>
          ...
          <div className='flex flex-wrap justify-center gap-4 mt-10'>
            <motion.button
              ...
              className='w-full max-w-sm flex items-center justify-center gap-3 py-3 bg-black text-white rounded-full shadow-md'>
              Start Interview
            </motion.button>
        ...
        <div className='flex flex-col md:flex-row justify-ceneter items-center gap-10 mb-28'>
          {
            [
              {
          ...
          <div className='grid md:grid-cols-2 gap-10'>
            {
              [
                ...
                },
                {
                  ...
                  desc:"SProject-specific questions based on resume."
                },
                {
                  image: pdfImg,
                  icon:<BsFileEarmarkText size={20}/>,
